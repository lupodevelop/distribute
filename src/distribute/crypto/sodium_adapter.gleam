//// Sodium crypto adapter for production use.
////
//// This adapter provides real cryptographic security using:
//// - **X25519** for key exchange (Curve25519 ECDH)
//// - **ChaCha20-Poly1305** for AEAD encryption
//// - **HKDF-SHA256** for key derivation
////
//// It uses Erlang's built-in `crypto` module (OpenSSL/LibreSSL backend),
//// requiring no external dependencies beyond standard OTP.
////
//// ## Features
////
